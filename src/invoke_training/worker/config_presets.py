"""
Configuration presets for different training types using invoke_training config structure.
"""
...
def get_flux_lora_config(
    ...
    **kwargs
    ...
    """
    Generate FLUX LoRA training configuration compatible with invoke_training.
    ...
    Args:
        ...
        transformer_learning_rate: Specific LR for transformer
        ...
        cache_vae_outputs: Cache VAE outputs
        ...
        memory_preset: Pre-configured memory settings
