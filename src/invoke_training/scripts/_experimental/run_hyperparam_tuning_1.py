...
def main():
    base_config_path = "/home/ryan/src/invoke-training/src/invoke_training/sample_configs/sdxl_lora_baroque_1x24gb.yaml"
    name_prefix = "output/hp_tuning/sdxl_lora_baroque_1x24gb/"

    run_overrides = [
        # Effect of varying the learning rate of the text encoder.
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-6, unet_learning_rate=1e-4),
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-5, unet_learning_rate=1e-4),
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-4, unet_learning_rate=1e-4),
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-3, unet_learning_rate=1e-4),
        # Effect of varying the learning rate of the UNet.
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-5, unet_learning_rate=1e-6),
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-5, unet_learning_rate=1e-5),
        Override(base_output_prefix=name_prefix, text_encoder_learning_rate=1e-5, unet_learning_rate=1e-3),
    ]
