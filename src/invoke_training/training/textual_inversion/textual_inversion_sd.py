...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Deprecated in favor of validation_steps. Run validation every X epochs. Validation consists of running the"
            " prompt `args.validation_prompt` multiple times: `args.num_validation_images` and logging the images."
        ),
    )
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        if args.checkpoints_total_limit is not None:
                            ...
                            # before we save the new checkpoint, we need to have at _most_ `checkpoints_total_limit - 1`
                            # checkpoints
