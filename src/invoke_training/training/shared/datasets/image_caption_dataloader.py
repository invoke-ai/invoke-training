...
def build_image_caption_dataloader(config: DatasetConfig, tokenizer: CLIPTokenizer, batch_size: int) -> DataLoader:
    """Construct a DataLoader for an image-caption dataset.
