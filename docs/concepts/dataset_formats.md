...
Once you've selected a dataset from the Hugging Face Hub, you can use it with any pipeline that supports the [HFDirImageCaptionDatasetConfig][invoke_training.config.shared.data.dataset_config.HFDirImageCaptionDatasetConfig] type.
